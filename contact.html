    ...
    <div class="site-wrap" id="home-section">
      ...
      <div class="owl-carousel-wrapper mb-md-5">
        ...
        <div
          ...
          style="background-image: url('images/hero_3.jpg')"></div>
      </div>

      <div
        class="site-section w-75 d-flex mx-auto mt-md-5"
        style="
              ...
              <div class="bg-white p-3 p-md-5">
                ...
                <ul class="list-unstyled footer-link">
                  <li class="d-block mb-3">
                    <span
                      class="d-block text-muted small text-uppercase font-weight-bold"
                      >Address:</span
                    >
