...
<body>
                    ...
                    <ul id="sidebarnav" style="overflow:hidden;">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="admin-contactus.php" aria-expanded="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class=" ti icon icon-tabler icon-tabler-user-circle" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="admin-contactus.php" aria-expanded="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="ti icon icon-tabler icon-tabler-settings" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
  ...
  bottom: 10px;">
                            <a class="sidebar-link" href="client-logout.php" aria-expanded="false">
                                <span>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <h5 class="card-title fw-semibold">Welcome <?php echo $detail->name ?></h5>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                    <div class="message-body">
                                        ...
                                        <a href="client-logout.php" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
